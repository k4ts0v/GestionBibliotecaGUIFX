...
public class ControladorFormLibro {
    ...
    @FXML private Label lblTitulo, lblIdLibro, lblTituloLibro, lblAutorLibro, lblISBNLibro, lblAnhadidoLibroExito, lblAnhadidoLibroError;
    @FXML private HBox hbAnhadidoLibroExito ,hbAnhadidoLibroError;
    @FXML private TextField txtIdLibro, txtTituloLibro, txtAutorLibro, txtISBNLibro;
    @FXML private Button btnDescartar, btnAnhadirLibro;
    @FXML private Tooltip ttComboBox, ttBtnDescartar, ttHlMenuPrincipal, ttTxtIdLibro, ttBtnAnhadirLibro, ttTxtTituloLibro, ttTxtAutorLibro, ttTxtIsbnLibro;
     ...
     * Si se ha realizado correctamente, muestra el mensaje de éxito.
