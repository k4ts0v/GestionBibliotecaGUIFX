...
/**
 * Esta clase representa el controlador del menú de recuperación de las contraseñas de los usuarios en la aplicación de biblioteca.
...
public class ControladorRecuperarContrasenha {
    ...
    @FXML private Label lblTitulo, lblUsuario, lblContrasenha, lblRecuperacionExitosa;
    ...
    @FXML private HBox hbRecuperacionExitosa;
    @FXML private VBox rootVBox;

    private ResourceBundle bundle;

    @FXML private Tooltip ttComboBox, ttHlMenuPrincipal, ttbtnIniciarSesion, ttRecuperarContrasenhaBtnRecuperarContrasenha, ttRecuperarContrasenhaTxtContrasenha, ttRecuperarContrasenhaTxtUsuario;
