...
/**
 * Esta clase representa el controlador del menú de registro de usuarios en la aplicación de biblioteca.
 * Permite al usuario registrarse en la plataforma,
...
public class ControladorRegistroUsuario {
    ...
    @FXML private Label lblTitulo, lblUsuario, lblValidacionNombre, lblValidacionEmail, lblValidacionContrasenha, lblEmail, lblContrasenha;
    @FXML private TextField txtUsuario, txtEmail;
    @FXML private PasswordField txtContrasenha;
    @FXML private Hyperlink hlIniciarSesion, hlMenuPrincipal;
    @FXML private Button btnRegistro;
    @FXML private HBox hbValidacionNombre, hbValidacionEmail, hbRegistroExitoso, hbValidacionContrasenha;
    @FXML private Tooltip ttComboBox, ttHlMenuPrincipal, ttBtnIniciarSesion, ttTxtContrasenha, ttTxtUsuario, ttTxtEmail, ttHlRegistro;
