...
/**
 * Esta clase representa el controlador del menú de gestión de libros en la aplicación de biblioteca.
 * Permite al usuario acceder a la vista de los libros,
...
public class ControladorVistaLibros {
    ...
    @FXML private ListView<Libro> listaLibros;
    @FXML private Button btnEditarLibro, btnBorrarLibro, btnAnhadirLibro;

    private ResourceBundle bundle;

    @FXML private Tooltip ttHlMenuPrincipal, ttBtnAnhadirLibro, ttBtnBorrarLibro, ttBtnEditarLibro, ttComboBox;
    ...
    private void initListaLibrosListener() {
        if (listaLibros != null) {
            ...
            // Acción realiada en click doble.
