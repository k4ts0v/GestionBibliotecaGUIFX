...
public class ControladorVistaPrestamos {
    ...
    @FXML private ListView<Prestamo> listaPrestamos;
    @FXML private Button btnEditarPrestamo, btnBorrarPrestamo, btnAnhadirPrestamo;

    private ResourceBundle bundle;

    @FXML private Hyperlink hlMenuPrincipal;

    @FXML private Tooltip ttHlMenuPrincipal, ttBtnAnhadirPrestamo, ttBtnBorrarPrestamo, ttBtnEditarPrestamo, ttComboBox;
