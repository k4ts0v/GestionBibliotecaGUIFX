...
public class ControladorFormPrestamo {
    ...
    @FXML
    private Label lblNombrePrestamo;
    @FXML
    ...
    @FXML
    private Label lblLibroId;
    @FXML
    private Label lblAnhadidoPrestamoExito;
    @FXML
    private HBox hbAnhadidoPrestamoExito;
    @FXML
    private Label lblAnhadidoPrestamoError;
    @FXML
    private HBox hbAnhadidoPrestamoError;
    ...
    @FXML
    private Tooltip ttTxtLibroId;
    @FXML
    private Tooltip ttTxtUsuarioId;
    @FXML
    private Tooltip ttTxtFechaInicio;
    @FXML
    private Tooltip ttTxtFechaFin;
    @FXML
    ...
    @FXML
    private Tooltip ttTxtIdPrestamo;
    ...
    private void anhadirPrestamo() throws IOException {
        ...
        try {
            ...
            Prestamo prestamo = txtIdPrestamo.getText().isEmpty()
                    ? new Prestamo(dpFechaInicio.getValue().toString(), dpFechaFin.getValue().toString(), Integer.parseInt(txtUsuario.getText()), Integer.parseInt(txtLibroId.getText()))
                    : new Prestamo(Integer.parseInt(txtIdPrestamo.getText()), dpFechaInicio.getValue().toString(), dpFechaFin.getValue().toString(), Integer.parseInt(txtUsuario.getText()), Integer.parseInt(txtLibroId.getText()));
    ...
    /**
     * Valida los datos del prestamo para que cumplan con los criterios de validación.
     * @return boolean True si los datos del prestamo son válidos, false en caso contrario.
     */
    private boolean validarDatos() {
        if (txtUsuario.getText().isEmpty() || txtLibroId.getText().isEmpty() || dpFechaInicio.getValue().isEqual(dpFechaFin.getValue()) || dpFechaInicio.getValue().isAfter(dpFechaFin.getValue()) || dpFechaInicio.getValue().equals(null) || dpFechaFin.getValue().equals(null)) {
    ...
    @FXML private void descartar() throws IOException {
    ...
    /**
     * Precarga los datos de un prestamo en los campos correspondientes para facilitar la edición.
